...
uniform mat4	 uModel;	 // Transforms: model space -> world space
uniform mat4	 uView;   // Transforms: world space -> eye space
uniform mat4	 uProj;   // Transforms: eye space   -> clip space
...
{  
	...
	gl_Position = uProj * uView * uModel * vec4( vertex, 1.0f );	
}