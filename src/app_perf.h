...
extern "C" void PERF_INIT ( int buildbits, bool cpu, bool gpu, bool cons, int lev, char* fname );
...
// R.Hoetzlein
	...
	public:
		...
		long GetFracDay ( Time& base );			// Return Unit = 5 mins
		long GetFracWeek ( Time& base );			// Return Unit = 1 hr
		long GetFracMonth ( Time& base );		// Return Unit = 4 hrs
		long GetFracYear ( Time& base );			// Return Unit = 1 day
		int GetDayOfWeek ();
		int GetWeekOfYear ();
